...
title:
  zh: "自进化智能体 (SEA)"
  en: "Self-Evolving Agent (SEA)"
slug: "self-evolving-agent"
date: "2025-12-15"
category: "AI Security"
techStack: ["Python", "Multi-Agent", "LLM"]
description:
  zh: "红队对抗系统，采用类似 AutoDAN 的自进化多智能体架构进行 AI 安全攻防研究。"
  en: "Red team adversarial system using AutoDAN-like self-evolving multi-agent architecture for AI security research."
